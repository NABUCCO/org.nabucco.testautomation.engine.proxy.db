...
/**
 * DatabaseEngineOperation
 * 
 * @author Steffen Schmidt, PRODYNA AG
 * 
 */
public interface DatabaseEngineOperation extends Serializable {

    /**
     * Executes the given action on the DatabaseEngineOperation.
     * 
     * @param context the context
     * @param propertyList the list properties
     ...
     */
     ActionResponse execute(TestContext context, PropertyList propertyList,
