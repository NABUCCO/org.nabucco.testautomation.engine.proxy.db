 ...
 * 
 */
public class DatabaseProxyConfigImpl extends AbstractProxyEngineConfiguration implements DatabaseProxyConfiguration {
     ...
     */
    public DatabaseProxyConfigImpl(ClassLoader classloader, ProxyConfiguration configuration) {
    ...
    public Properties getDatabaseProperties() {
        ...
        props.setProperty("user", getConfigurationValue(DatabaseProxyConfigurationType.DATABASE_USER.getKey()).trim());
        props.setProperty("password", getConfigurationValue(DatabaseProxyConfigurationType.DATABASE_PASSWORD.getKey())
                .trim());
        return props;
    }
