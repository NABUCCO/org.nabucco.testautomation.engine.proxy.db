...
public class DatabaseClassloader {
    ...
    private static final NabuccoLogger logger = NabuccoLoggingFactory.getInstance()
            .getLogger(DatabaseClassloader.class);
     ...
     * 
     */
    public DatabaseClassloader(File rootPath) throws ProxyConfigurationException {
     ...
     * @param driverClass
     *            the name of the driver class to be loaded
     * @return the database driver instance
     * @throws ProxyConfigurationException
     *             thrown, if the driver could not be loaded
     */
    public Driver getDatabaseDriver(String driverJar, String driverClass) throws ProxyConfigurationException {
        ...
        try {
            ...
            throw new ProxyConfigurationException("Could not convert to URL: " + driverJar, ex);
        }
        ...
        try {
            ...
            throw new ProxyConfigurationException("Could not find driver class: " + driverClass, ex);
        } catch (InstantiationException ex) {
            throw new ProxyConfigurationException("Could not instantiate driver class: " + driverClass, ex);
        } catch (IllegalAccessException ex) {
            throw new ProxyConfigurationException("Could not access driver class: " + driverClass, ex);
        }
    }
