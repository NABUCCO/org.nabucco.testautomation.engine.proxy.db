...
public class DatabaseImpl implements Database {
    ...
    private static final NabuccoLogger logger = NabuccoLoggingFactory.getInstance().getLogger(DatabaseImpl.class);
    ...
    public ActionResponse execute(TestContext context, PropertyList propertyList, List<Metadata> metadataList,
        ...
        try {
            ...
            logger.fatal(ex);
            result.setErrorMessage("Could not execute " + actionType + ". Cause: " + ex.toString());
            result.setActionStatus(ActionStatusType.FAILED);
        } finally {
