 ...
 */
public abstract class AbstractDatabaseCommand extends AbstractProxyCommand implements DatabaseCommand {

    private static final NabuccoLogger logger = NabuccoLoggingFactory.getInstance().getLogger(DatabaseCommand.class);
