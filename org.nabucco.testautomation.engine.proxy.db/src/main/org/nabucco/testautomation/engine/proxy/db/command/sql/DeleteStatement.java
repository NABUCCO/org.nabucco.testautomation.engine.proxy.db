 ...
 */
public class DeleteStatement extends AbstractSQLCommand {
    ...
    public PropertyList execute(Metadata metadata, PropertyList propertyList) throws SQLCommandException {
        ...
        try {
            ...
            this.setResponse(row_count + " row(s) affected in " + (this.getStop() - this.getStart()) + " ms");
    ...
    private PropertyList createResultProperty(int row_count) {
        ...
        NumericProperty rowCountProperty = PropertyHelper.createNumericProperty(ROW_COUNT, row_count);
